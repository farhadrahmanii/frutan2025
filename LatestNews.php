...
<div data-scroll-container>
    <div data-controller="blog">
        ...
        <div class="category-filter">
            <div class="cat-lg">
                <?php
                $fetchCats = showCategory();
                foreach ($fetchCats as $cats) {
                    ?>
                    <p class="blog-cat" data-cat="<?php echo $cats['name'] ?>"><?php echo $cats['name'] ?> </p>
                <?php } ?>
            </div>
        </div>
        <div class="post-cont">
            <div class="columns car-cont" id="post-container" style="position: relative; height:auto;">
                <?php
                $Feach = showAllPost('0,30');
    ...
    <script>
        // document.querySelectorAll('.blog-cat').forEach(category => {
        //     category.addEventListener('click', function () {
        //         const selectedCategory = this.getAttribute('data-cat');
        //         fetch('./fetchPostsByCategory.php', {
        //             method: 'POST',
